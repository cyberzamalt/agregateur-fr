...
// Neutralise les typings instables de react-leaflet côté CI/Render
      ...
      >
        <MapContainer center={center} zoom={6} style={{ width: "100%", height: "100%" }}>
          ...
          {features.map((f) => {
            ...
            return (
              <Marker key={f.properties.id} position={pos} icon={defaultIcon}>
                <Popup>
